<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editarVehiculos.aspx.cs" Inherits="Biblioteca.Web.editarVehiculos" %>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Editar Vehiculos</div>
            </div>
          </div>

          <div class="section-body">
              <h2 class="section-title">Editar Vehiculos</h2>
             ...
             <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                            <asp:Button class="btn btn-primary btn-lg btn-icon icon-right" tabindex="4" ID="btnBuscar" runat="server" Text="Buscar Vehiculo" OnClick="btnBuscar_Click"   />
                        </div>
                     </div>
                  </div>
               </div>
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <div class="form-group">
                    <asp:Button class="btn btn-primary btn-lg btn-icon icon-right" tabindex="4" ID="btnModificar" runat="server" Text="Modificar Vehiculo" OnClick="btnModificar_Click"  />
                   </div>
                     <div class="form-group">
                    <asp:Button class="btn btn-primary btn-lg btn-icon icon-right" tabindex="4" ID="btnEliminar" runat="server" Text="Eliminar Vehiculo" OnClick="btnEliminar_Click"   />
                     </div>
                     </div>
                  </div>
               </div>
