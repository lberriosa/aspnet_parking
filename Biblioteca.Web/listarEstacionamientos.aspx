<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listarEstacionamientos.aspx.cs" Inherits="Biblioteca.Web.listarEstacionamientos" %>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_estacionamientoConnectionString9 %>" SelectCommand="select e.COD_ESTACIONAMIENTO,e.DIRECCION, e.PRECIO_HORA, e.HABILITADO, concat(u.NOMBRE_USUARIO,' ' ,u.APELLIDO_USUARIO) as &quot;nombre usuario&quot;, e.RUT_USUARIO from ESTACIONAMIENTO e join USUARIO u on e.RUT_USUARIO = u.RUT_USUARIO;"></asp:SqlDataSource>

              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" DataKeyNames="COD_ESTACIONAMIENTO">
                  <AlternatingRowStyle BackColor="White" />
                  <Columns>
                      <asp:BoundField DataField="COD_ESTACIONAMIENTO" HeaderText="Codigo Estacionamiento" SortExpression="COD_ESTACIONAMIENTO" ReadOnly="True" />
                      <asp:BoundField DataField="DIRECCION" HeaderText="Direccion Estacionamiento" SortExpression="DIRECCION" />
                      <asp:BoundField DataField="PRECIO_HORA" HeaderText="Valor Por Hora " SortExpression="PRECIO_HORA" />
                      <asp:CheckBoxField DataField="HABILITADO" HeaderText="Estacionamiento Habilitado" SortExpression="HABILITADO" />
                      <asp:BoundField DataField="nombre usuario" HeaderText="Dueño Estacionamiento" ReadOnly="True" SortExpression="nombre usuario" />
                      <asp:BoundField DataField="RUT_USUARIO" HeaderText="Rut Dueño " SortExpression="RUT_USUARIO" />
                  </Columns>
